...
{/* Mid footer */}
      ...
      <div className='px-3 cursor-pointer items-center'>
        ...
        <p  className='text-sm hover:underline py-1 font-light'>UK Modern Slavery</p>
        <p className='text-sm hover:underline py-1 font-light'>Sustainability</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Science</p>
      </div>

      <div className='px-3 cursor-pointer'>
      <h2 className='font-bold py-2 '>Make Money with Us</h2>
        <p className='text-sm hover:underline py-1 font-light'>Sell on Amazon</p>
        <p className='text-sm hover:underline py-1 font-light'>Sell on Amazon Business</p>
        <p  className='text-sm hover:underline py-1 font-light'>Sell on Amazon Handmade</p>
        <p className='text-sm hover:underline py-1 font-light'>Sell on Amazon Launchpad</p>
        <p className='text-sm hover:underline py-1 font-light'>Protect and build your brand</p>
        <p className='text-sm hover:underline py-1 font-light'>Associates Program</p>
        <p className='text-sm hover:underline py-1 font-light'>Fulfilment by Amazon</p>
        <p className='text-sm hover:underline py-1 font-light'>Seller Fulfilled Prime</p>
        <p className='text-sm hover:underline py-1 font-light'>Advertise your Products</p>
        <p className='text-sm hover:underline py-1 font-light'>Independently Publish with Us</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Pay</p>
        <p className='text-sm hover:underline py-1 font-light'>Host an Amazon Hub</p>
        <p className='flex text-sm hover:underline py-1 '> <ChevronRightIcon className='h-2 flex mt-1 mr-1'/> See More Make Money with Us</p>
      </div>

      <div className='px-3 cursor-pointer'>
      <h2 className='font-bold py-2 '>Amazon Payment Methods</h2>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Platinum Mastercard</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Classic Mastercard</p>
        <p  className='text-sm hover:underline py-1 font-light'>Amazon Money Store</p>
        <p className='text-sm hover:underline py-1 font-light'>Gift Cards</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Currency Converter</p>
        <p className='text-sm hover:underline py-1 font-light'>Payment Methods Help</p>
        <p className='text-sm hover:underline py-1 font-light'>Shop with Points</p>
        <p className='text-sm hover:underline py-1 font-light'>Top Up Your Account</p>
        <p className='text-sm hover:underline py-1 font-light'>Top Up Yoour Account in Store</p>
      </div>

      <div className='px-3 cursor-pointer'>
      <h2 className='font-bold py-2 '>Let Us Help You</h2>
        <p className='text-sm hover:underline py-1 font-light'>COVID-19 and Amazon</p>
        <p className='text-sm hover:underline py-1 font-light'>Track Packages or View Orders</p>
        <p  className='text-sm hover:underline py-1 font-light'>Delivery Rates & Policies</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Prime</p>
        <p className='text-sm hover:underline py-1 font-light'>Returns & Replacements</p>
        <p className='text-sm hover:underline py-1 font-light'>Recycling</p>
        <p className='text-sm hover:underline py-1 font-light'>Manage Your Content and Devices</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Mobile App</p>
        <p className='text-sm hover:underline py-1 font-light'>Amazon Assistant</p>
        <p className='text-sm hover:underline py-1 font-light'>Customer Service</p>
      </div>
